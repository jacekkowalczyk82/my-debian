...
mkdir -p /home/kowalczy/live-build-config/kali-config/variant-mate_openbox/package-lists/
...
cp -v /opt/my-debian/variant-mate_openbox/package-lists/kali.list.chroot /home/kowalczy/live-build-config/kali-config/variant-mate_openbox/package-lists/kali.list.chroot
